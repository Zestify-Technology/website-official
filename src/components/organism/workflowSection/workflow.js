...
const steps = [
  {
    number: "01",
    title: "Subscribe to any Plan",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum hendrerit leo et volutb. Suspendisse suscipit justo sed pharetra elementum.",
  },
  {
    number: "02",
  ...
  {
    number: "03",
    title: "and Boooom! Project is Ready!",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum hendrerit leo et volutb. Suspendisse suscipit justo sed pharetra elementum.",
  },
];
...
export default function WorkflowSection() {
  ...
  const activeBubbleCenter = activeStep * stepSpacing + BUBBLE_OFFSET + BUBBLE_SIZE / 2;
  const trackTotal = (steps.length - 1) * stepSpacing;

  return (
    <Section id="workflow" className="isolate  overflow-hidden w-full px-4 sm:px-8 py-16 lg:py-24">
        ...
        <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start lg:items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <Paragraph>
              ...
              content in the module Design settings and even apply custom CSS.
            </Paragraph>
          </div>
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] font-semibold tracking-[0.18em] uppercase mb-1 text-blue-400 transition-all duration-300 ${
                        activeStep === i ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"
                      }`}
                    >
                      Step {step.number}
                    </p>
                    ...
                    <div className="relative">
                      <p
                        className={`absolute left-0 right-0 text-sm text-neutral-500 leading-relaxed transition-all duration-500 ${
                          activeStep === i ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"
                        }`}
                        style={{ top: "4px" }}
                      >
                        {step.description}
