...
export default function WorkflowSection() {
  ...
  return (
    <Section id='workflow' direction="col" className="gap-20 lg:p-20 lg:flex-row">
        {/* ── LEFT ── */}
        <div className="flex flex-col gap-5 lg:w-1/2">
          <div className="w-1/2">
            <Label variant="glass">Tahapan</Label>
          </div>
          <Heading level={2}>
            Merencanakan solusi teknologi terbaru pada bisnis
          </Heading>
          <Paragraph>
