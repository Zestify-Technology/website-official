...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Kami membangun ekosistem teknologi berbasis AI untuk efisiensi bisnis Anda. Satu sistem cerdas yang mampu menghadirkan ribuan solusi digital otomatis dan tepat guna.',
...
const organizationData = {
  ...
  sameAs: [
    'https://instagram.com/zestify.my.id',
  ],
}
